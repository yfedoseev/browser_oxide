...
//!
//! Some sites specifically deliver their `script-src 'strict-dynamic'`
//! directive via meta-tag, not via response header — so without this
//! collector we'd never see the strict-dynamic that blocks the
//! bot-detection bundle.

use crate::dom::node::{NodeData, NodeId};
use crate::dom::Dom;
use crate::net::csp::PolicySet;
