...
mod tests {
    use super::*;
    use crate::css_selectors::Element as _;
    ...
    fn selector_matching_on_parsed_html() {
        ...
        let sel = crate::css_selectors::parse_selector_list("div#main.content").unwrap();
        assert!(crate::css_selectors::matches_selector(&div_el, &sel[0]));

        let sel2 = crate::css_selectors::parse_selector_list("body > div").unwrap();
        assert!(crate::css_selectors::matches_selector(&div_el, &sel2[0]));
    }
}
