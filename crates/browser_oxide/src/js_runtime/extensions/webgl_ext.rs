...
use crate::canvas::webgl_render::WebGLContext;
#[cfg(feature = "webgl-render")]
...
#[op2(fast)]
pub fn op_webgl_available(state: &mut OpState) -> bool {
    let state = state.borrow::<WebGLState>();
    state.available
}
...
pub fn op_webgl_create_context(
    ...
    let _state = _state.borrow_mut::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    {
...
/// Compile a shader.
#[op2(fast)]
pub fn op_webgl_compile_shader(_state: &mut OpState, #[smi] _ctx_id: i32, #[smi] _shader_id: i32) {
    let _state = _state.borrow_mut::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get_mut(&_ctx_id) {
...
pub fn op_webgl_get_shader_parameter(
    ...
    let _state = _state.borrow::<WebGLState>();
    #[cfg(feature = "webgl-render")]
...
#[op2(fast)]
#[smi]
pub fn op_webgl_create_program(_state: &mut OpState, #[smi] _ctx_id: i32) -> i32 {
    let _state = _state.borrow_mut::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get_mut(&_ctx_id) {
...
/// Link program.
#[op2(fast)]
pub fn op_webgl_link_program(_state: &mut OpState, #[smi] _ctx_id: i32, #[smi] _program_id: i32) {
    let _state = _state.borrow::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get(&_ctx_id) {
...
/// Use program.
#[op2(fast)]
pub fn op_webgl_use_program(_state: &mut OpState, #[smi] _ctx_id: i32, #[smi] _program_id: i32) {
    let _state = _state.borrow::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get(&_ctx_id) {
...
#[op2(fast)]
#[smi]
pub fn op_webgl_create_buffer(_state: &mut OpState, #[smi] _ctx_id: i32) -> i32 {
    let _state = _state.borrow_mut::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get_mut(&_ctx_id) {
...
pub fn op_webgl_clear_color(
    ...
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get(&_ctx_id) {
        ctx.clear_color(_r as f32, _g as f32, _b as f32, _a as f32);
    }
}

/// Clear.
#[op2(fast)]
pub fn op_webgl_clear(_state: &mut OpState, #[smi] _ctx_id: i32, #[smi] _mask: u32) {
    let _state = _state.borrow::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get(&_ctx_id) {
        ctx.clear(_mask);
...
/// Enable capability.
#[op2(fast)]
pub fn op_webgl_enable(_state: &mut OpState, #[smi] _ctx_id: i32, #[smi] _cap: u32) {
    let _state = _state.borrow::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get(&_ctx_id) {
        ctx.enable(_cap);
...
/// Disable capability.
#[op2(fast)]
pub fn op_webgl_disable(_state: &mut OpState, #[smi] _ctx_id: i32, #[smi] _cap: u32) {
    let _state = _state.borrow::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get(&_ctx_id) {
        ctx.disable(_cap);
...
#[op2(fast)]
#[smi]
pub fn op_webgl_get_error(_state: &mut OpState, #[smi] _ctx_id: i32) -> u32 {
    let _state = _state.borrow::<WebGLState>();
    #[cfg(feature = "webgl-render")]
    if let Some(ctx) = _state.contexts.get(&_ctx_id) {
