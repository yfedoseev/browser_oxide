...
//! quantized floats for `getBoundingClientRect` and friends. A
//! bot-detection pHash hashes these values across `querySelectorAll('*')`. Engines that
...
/// Bot-detection pHash-style probe: walk all elements, hash their rect floats.
