...
struct SiteResult {
    ...
    #[allow(
        dead_code,
        reason = "surfaced via per-site .json artifact; held for future inspection"
    )]
    extracted: Value,
}
...
async fn run_creepjs(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
...
async fn run_pixelscan(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
...
async fn run_rebrowser(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
...
async fn run_fingerprint_demo(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
...
async fn run_amiunique(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
...
async fn run_eff(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
...
async fn run_deviceinfo(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
...
async fn run_managed_challenge_page(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
    ...
    // A challenge interstitial typically resolves to real content
...
async fn run_interstitial(profile: browser_oxide::stealth::StealthProfile) -> SiteResult {
