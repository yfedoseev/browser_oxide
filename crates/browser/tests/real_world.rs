...
// ============================================================
// Tier 1: Cloudflare-protected sites
// ============================================================

/// nowsecure.nl — Cloudflare Bot Management test page.
/// A 403 from curl but 200 from a real browser means CF is doing JS checks.
/// We verify we at least get an HTTP response (CF may still challenge us).
#[tokio::test]
#[ignore]
...
// ============================================================
// Tier 2: DataDome-protected sites
// ============================================================

/// g2.com — protected by DataDome.
/// DataDome checks TLS fingerprint, headers, and JS sensors.
#[tokio::test]
#[ignore]
async fn datadome_g2_com() {
    ...
    // DataDome either passes us (200) or shows a captcha page (403)
    assert!(
