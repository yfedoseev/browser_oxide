...
[`crates/browser_oxide/examples/getting_started.rs`](../crates/browser_oxide/examples/getting_started.rs):

```bash
cargo run --release -p browser_oxide --example getting_started -- https://example.com
```
