...
| 4 | **FIX-D** | apple_m3_macos GpuProfile aligned to WebGL 2 captured fixture: 36-ext list (was 40-mix), MAX_VIEWPORT_DIMS [16384,16384] (was [32767,32767]), ALIASED_POINT_SIZE_RANGE [1,511] (was [1,8190]) | 0-7 (cross-API correlation) | 2h shipped | ✅ (commit pending) | `crates/stealth/src/gpu.rs` |
